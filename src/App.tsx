...
function App() {
  ...
  function loadSafeCandidate() {
    setCandidateDescription(
      'Cinematic vertical medium-low angle inside the dying Meridian greenhouse core, favoring Mara Venn\'s raised left glove and the flooded floor. With Orison\'s last viable seed archive at stake, Mara has warm brown skin, a long silver braid, amber visor, compact oxygen pack, empty hands, and a charcoal pressure suit with copper seams. Mounted on her left glove, the triangular beacon key is the direct and only origin of a blue triangular route map spreading across the flooded floor, bending around the fallen glass arch, and terminating at the closed, still-locked seed-vault airlock beneath the water. Behind Mara, Kestrel-9 remains a white spherical survey drone with three folding fins and three red lens clusters, emitting a separate thin red scan only. Fractured glass arches, zero-gravity vines, floating water spheres, and teal emergency strips remain visible. No physical stranger, weapons, dialogue, captions, or invented interface text.',
    );
    setResult(null);
  }
